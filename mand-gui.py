...
if __name__ == '__main__':
    ...
    xbbox = QVBoxLayout()
    xbbox.addWidget(QLabel('Selection X Coordinate (LLC)'))
    xbbox.addWidget(xbox)
    xbsect = QWidget()
    xbsect.setLayout(xbbox)
    hbox.addWidget(xbsect)

    ybbox = QVBoxLayout()
    ybbox.addWidget(QLabel('Selection Y Coordinate (LLC)'))
    ybbox.addWidget(ybox)
    ybsect = QWidget()
    ybsect.setLayout(ybbox)
    hbox.addWidget(ybsect)

    wbbox = QVBoxLayout()
    wbbox.addWidget(QLabel('Selection Width'))
    wbbox.addWidget(wbox)
    wbsect = QWidget()
    wbsect.setLayout(wbbox)
    hbox.addWidget(wbsect)

    inbox = QVBoxLayout()
    inbox.addWidget(QLabel('Iteration Multiplier'))
    inbox.addWidget(inter)
    insect = QWidget()
    insect.setLayout(inbox)
    hbox.addWidget(insect)
    ...
    btnsect = QWidget()
    btnsect.setLayout(btnbox)
    hbox.addWidget(btnsect)
